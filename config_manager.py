...
def load_config():
    ...
    if "Uncategorized" not in categories:
        categories["Uncategorized"] = {"rules": [], "history": []}
...
def initialize_default_categories():
    ...
    return {
        "Uncategorized": {"rules": [], "history": []},
        "Code": {"rules": ["def ", "class ", "import ", "function(", "=>", "{", "}"], "history": []},
        "Links": {"rules": [r"regex:https?://", r"regex:www\."], "history": []},
        "Text": {"rules": [], "history": []} # Catch-all for general text if needed
    }
...
def save_config(categories_data):
    ...
    for cat_name, cat_data in categories_data.items():
        # Ensure only serializable data (rules, history) is saved
